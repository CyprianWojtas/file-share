import { DirectoryDownload } from "../Downloader.js";
import { DirectoryInfo, FileInfo } from "../Shared.js";
import { createNodeTree, toFileSize } from "../Utils.js";

export default
class DownloadStatusDirectory
{
	element: HTMLElement;

	private _directoryDownload: DirectoryDownload;
	private _elHooks:
	{
		dirName: HTMLElement,
		...
		fileProgressText: HTMLElement,
		fileProgresBg: HTMLElement,
	...
	private _fileProgress: number | string;
	private _fileSize: number;
	private _progress: number | string;
	private _size: number;
	private _speed: number;

	constructor(directoryDownload: DirectoryDownload)
	{
	...
	set fileProgress(newValue: number | string)
	{
	...
	private bindEvents()
	{
		this._directoryDownload.on("directoryInfo", (dirInfo: DirectoryInfo) =>
		{
			this.dirName = dirInfo.name;
		});

		this._directoryDownload.on("fileInfo", (fileInfo: FileInfo) =>
		{
